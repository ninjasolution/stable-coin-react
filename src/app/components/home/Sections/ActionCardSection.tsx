  ...
  return (
    <>
      <section className="my-5 md:px-10 py-10">
        <div className=" flex justify-center md:flex-row flex-col md:px-10 items-center">
          <InfoCard
          ...
          <div className="relative m-5 sm:m-0 flex-1 px-5 py-3 border bg-white card-box-shadow flex flex-col gap-5 items-center max-w-[30rem]  whitespace-nowrap rounded-md  ">
            <p className="bg-yallow_300 absolute text-xs rounded right-7 top-10 sm:top-5 px-2 py-1 ">
              Hot
            </p>
            <Image
              src="/btcdollericon.png"
              height={150}
              width={150}
              alt="icon"
            />
            ...
            <p className="text-sm leading-[20px] text-offwhite_100 whitespace-normal ">
              Purchase 1:1 with USD via wire transfer, or top up your Binance
              Spot Wallet with other currencies to exchange to BUSD.
            </p>
