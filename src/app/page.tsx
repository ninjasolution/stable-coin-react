  ...
  return (
    <main className=" min-h-screen bg-yallow_50 text-black_100 ">
      <div>
        ...
        <BreakTitleSection title="As of Jus 23,2023" />

        {/* Action Card Section */}
        <ActionCardSection />
        {/* why Busd */}
        <WhyBusd title="Why BUSD" />

        {/* Reserve Breakdown Section */}

        <ReserveSection title={"Monthly BUSD Reserve Breakdown"} />

        <AttestationSection title="Attestation Report" />
        <FaqSection />
        <PopularCaseCard />
